...
$service=$_POST['service'];
    ...
    $sql="INSERT INTO emergency(email,date,service) VALUES('$user','$date','$service')";
    $data=mysqli_query($connect,$sql);

    if($data) {
        ?>
          <script type="text/javascript">
               alert("Emergency Appointment Successfull")
          </script>
        <?php
     }
    }
        ...
        <div class="container">
            <div class="row gx-0">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                   <form method="POST"> <div class="bg-dark d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Emergency Appointment</h3>
                        <div class="date mb-3" id="date" data-target-input="nearest">
                            <input type="text" class="form-control bg-light border-0 datetimepicker-input"
                                placeholder="Appointment Date" data-target="#date" data-toggle="datetimepicker" style="height: 40px;" name="date">
                        </div>
                        <select class="form-select bg-light border-0 mb-4" style="height: 40px;" name="service">
            ...
            {
            ?>
                        <button type="submit" class="btn btn-light" name="emergency">Emergency Appointment</button>
